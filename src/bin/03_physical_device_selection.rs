...
impl VulkanApp {
    ...
    pub fn new() -> VulkanApp {
        ...
        let instance = utility::vulkan::create_instance(&entry, WINDOW_TITLE, IS_ENABLE_VALIDATION_LAYERS, &REQUIRED_VALIDATION_LAYERS.to_vec());
        let (debug_report_loader, debug_callback) = utility::debug::setup_debug_callback( IS_ENABLE_VALIDATION_LAYERS, &entry, &instance);
