...
impl VulkanApp {
    ...
    fn create_index_buffer(instance: &ash::Instance<V1_0>, device: &ash::Device<V1_0>, physical_device: vk::PhysicalDevice, command_pool: vk::CommandPool, submit_queue: vk::Queue)
        -> (vk::Buffer, vk::DeviceMemory) {
