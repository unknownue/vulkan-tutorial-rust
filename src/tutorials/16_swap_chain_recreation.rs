...
impl VulkanApp {
    ...
    pub fn new(event_loop: &winit::EventsLoop) -> VulkanApp {
        ...
        let command_buffers = share::v1::create_command_buffers(&device, command_pool, graphics_pipeline, &swapchain_framebuffers, render_pass, swapchain_stuff.swapchain_extent);
    ...
    fn recreate_swapchain(&mut self) {
        ...
        let (graphics_pipeline, pipeline_layout) = share::v1::create_graphics_pipeline(&self.device, self.render_pass, swapchain_stuff.swapchain_extent);
        ...
        self.command_buffers = share::v1::create_command_buffers(&self.device, self.command_pool, self.graphics_pipeline, &self.swapchain_framebuffers, self.render_pass, self.swapchain_extent);
    }
